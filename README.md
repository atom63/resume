<!--
  MAINTAINER / AGENT NOTE — this landing README is hand-maintained ONLY in the
  mirror; scripts/release-resume-public.sh does NOT sync it. It shares messaging
  with packages/resume/README.md (the npm README, which IS synced from the
  monorepo). When you change the pitch in one, change it in the other too.
-->
